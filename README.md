...
Seja bem-vindo !!! O __GitCompleto__ é um espaço dedicado à documentação e compartilhamento de conhecimentos sobre Git como plataforma de versionamento de código. Através da parceria entre a UFMS e a Compass.uol, o repositório reúne estudos, materiais e reflexões sobre as práticas ágeis, com o objetivo de fomentar o aprendizado e a troca de experiências entre a comunidade.

## 📌 Navegação

- [📝 Sobre o GIT](#introdução)
